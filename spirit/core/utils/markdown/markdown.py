...
class Markdown(mistune.Markdown):
    ...
    def output_block_math(self):
        return self.renderer.block_math(text=self.token["text"])
    ...
    def output_vimeo_link(self):
        return self.renderer.vimeo_link(video_id=self.token["video_id"])

    def output_gfycat_link(self):
        return self.renderer.gfycat_link(video_id=self.token["video_id"])
