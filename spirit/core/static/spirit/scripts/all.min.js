...
(function(){var $;$=jQuery,$.extend({format:function(str,kwargs){var key,value;for(key in kwargs)value=kwargs[key],str=str.replace("{"+key+"}",String(value));return str}}),stModules.utils={format:function(str,kwargs){var key,value;for(key in kwargs)value=kwargs[key],str=str.replace("{"+key+"}",String(value));return str},isHidden:function(elms){return 0===Array.from(elms).filter(function(elm){return"none"!==elm.style.display}).length}}}).call(this);
